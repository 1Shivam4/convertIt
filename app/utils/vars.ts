...
export const navbarItems: NavbarItemsProps[] = [
  ...
  },
  {
    ...
    itemsList: [
      {
        name: "Convert Video (MP4/WebM)",
        location: "/tools/media?tool=mp4",
        icon: "/icons/video.svg",
        description: "Transcode video files to MP4, WebM, MOV, and MKV",
      },
      {
        name: "Extract Audio (MP3/WAV)",
        location: "/tools/media?tool=mp3",
        icon: "/icons/video.svg",
        description: "Extract clean audio tracks from video files",
      },
      {
        name: "Video to Animated GIF",
        location: "/tools/media?tool=gif",
        icon: "/icons/video.svg",
        description: "Convert video clips into animated GIFs",
      },
      {
        name: "Compress Video",
        location: "/tools/media?tool=compress-video",
        icon: "/icons/compress.svg",
        description: "Reduce video bitrates and file sizes efficiently",
      },
    ],
  },
  {
    ...
    itemsList: [
      {
        name: "JSON ⇋ YAML",
        location: "/tools/developer",
        icon: "/icons/yaml.svg",
        description: "Convert and validate JSON and YAML data",
      },
      {
        name: "CSV ⇋ JSON",
        location: "/tools/developer",
        icon: "/icons/csv.svg",
        description: "Convert tabular CSV data to JSON array",
      },
      {
      ...
      },
      {
        ...
        location: "/tools/developer",
        icon: "/icons/html_to_pdf.svg",
        description: "Encode and decode URI strings and query params",
      },
      {
        name: "Hash Generator",
        location: "/tools/developer",
